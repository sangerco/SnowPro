...
router.post('/api/tags', auth_1.ensureLoggedIn, auth_1.checkIfUserOrAdmin, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                validator = jsonschema.validate(req.body, tagNew_json_1.default);
                if (!validator.valid) {
                    errors = validator.errors.map(function (e) { return e.stack; });
                    throw new expressError_1.BadRequestError(errors);
                }
                tag = req.body.tag;
                return [4 /*yield*/, tag_1.default.createTag(tag)];
            case 1:
                result = _a.sent();
                return [2 /*return*/, res.status(201).json({ result: result })];
            case 2:
                e_1 = _a.sent();
...
router.get('/tags', auth_1.ensureLoggedIn, auth_1.checkIfUserOrAdmin, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, tag_1.default.getTags()];
            case 1:
                tags = _a.sent();
                return [2 /*return*/, res.json({ tags: tags })];
            case 2:
                e_2 = _a.sent();
...
router.get('/tags/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, tag_1.default.getAssociatedItems(req.params.id)];
            case 1:
                tag = _a.sent();
                return [2 /*return*/, res.json({ tag: tag })];
            case 2:
                e_3 = _a.sent();
...
router.delete('/api/tags/:id', auth_1.ensureLoggedIn, auth_1.checkIfUserOrAdmin, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, tag_1.default.deleteTag(req.params.id)];
            case 1:
                _a.sent();
                return [2 /*return*/, res.json({ deleted: "Tag deleted: ".concat(req.params.id) })];
            case 2:
                e_4 = _a.sent();
