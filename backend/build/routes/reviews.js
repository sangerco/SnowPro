...
router.patch('/reviews/:id', auth_1.ensureLoggedIn, auth_1.checkIfUserOrAdmin, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
...
router.delete('/api/reviews/:id', auth_1.ensureLoggedIn, auth_1.checkIfUserOrAdmin, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var e_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
router.post('/reviews/:id/reply', auth_1.ensureLoggedIn, auth_1.checkIfUserOrAdmin, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var validator, errors, _a, userId, reviewId, body, reply, e_3;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                _a = req.body, userId = _a.userId, reviewId = _a.reviewId, body = _a.body;
                return [4 /*yield*/, reviewReply_1.default.replyToReview(userId, reviewId, body)];
            case 1:
                reply = _b.sent();
...
router.patch('/reviews/reply/:id', auth_1.ensureLoggedIn, auth_1.checkIfUserOrAdmin, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var validator, errors, reply, e_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
