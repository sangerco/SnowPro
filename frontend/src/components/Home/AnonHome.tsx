...
import { Container, Dimmer, Loader, Segment, Image, Grid, List, Header } from "semantic-ui-react";
    ...
    const skiAreas = skiAreaResponse.map((skiArea) => {
        return (
            <List key={skiArea.slug}>
                <List.Item>
                    <Link to={`/ski-areas/${skiArea.slug}`}><Header as='h3'>{skiArea.name}</Header></Link>
                </List.Item>
            </List>
        )
    })
                                ...
                                <Grid>
                                    <Grid.Row>
                                        <Grid.Column>
                                            ...
                                            <Header as='h3'><i>Get snow conditions, lift info, ski area reviews, and more!</i></Header>
                                        </Grid.Column>
                                    </Grid.Row>
                                </Grid>
                            </Container>
