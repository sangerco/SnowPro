        ...
        return (
            <Card fluid>
                <Card.Content textAlign='left'>
                    ...
                    <Card.Meta textAlign="left"><Header as='h6'>By {review.username}</Header></Card.Meta>                
                    <Card.Meta textAlign='right'><i>{date}</i></Card.Meta> 
                    <Card.Description><p>{review.body}</p></Card.Description>  
                </Card.Content>  
                <Card.Content extra>
