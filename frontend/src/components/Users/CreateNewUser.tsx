...
const CreateUserForm: React.FC<NewUserProps> = ({ newUser, loading, error, sendNewUserData }) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    await sendNewUserData(formData.username, formData.password, formData.first_name, formData.last_name, formData.email)
