...
const UserUpdateForm: React.FC<UpdateDataProps> = ({ user, updateUserData }) => {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            try {
                const response: AxiosResponse<UpdateData> = await axios.get(`${URL}/users/${username}`);
    ...
    return (
        <Form onSubmit={handleSubmit} error>
            ...
            <input placeholder='Last Name' name='last_name' value={formData.last_name} onChange={handleChange}/>
            </Form.Field>
            <Form.Field>
            ...
            <Form.Field>
                ...
                <Input placeholder="Add a link for an avatar" name='avatar' value={formData.avatar} onChange={handleChange}/>
            </Form.Field>
            <Form.TextArea>
                <label>Bio</label>
                <Input placeholder="Say a little something about yourself!" name='bio' value={formData.bio} onChange={handleChange}/>
            </Form.TextArea>
