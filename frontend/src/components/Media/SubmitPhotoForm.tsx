...
import { sendNewPhotoData } from "../../redux/actions/mediaActions";
...
type NewPhotoProps = PropsFromRedux & {
...
const SubmitPhotoForm: React.FC<NewPhotoProps> = ({
  newPhoto,
  error,
  sendNewPhotoData,
  fetchTagData,
...
// @ts-ignore
export default connector(SubmitPhotoForm);
